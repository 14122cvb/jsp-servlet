...
<div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <center>
        <form name="add_form" action="trademark.do" charset="UTF-8" method="get">
	...
	<center>
        ...
        %>
		   ...
		   <tr>
		   <td><%=i+1 %></td>
		   	<td><%=list_trademark.get(i).getName() %></td>
		   	<td><%=list_trademark.get(i).getOrder_sort() %></td>
		   	<td><a href="trademark.jsp?function=edit&id=<%=list_trademark.get(i).getId() %>&order_st=<%=list_trademark.get(i).getOrder_sort() %>&name_st=<%=list_trademark.get(i).getName() %>">Sửa</a>/<a href="trademark.do?function=delete&id=<%=list_trademark.get(i).getId() %>">Xóa</a></td>
		   </tr>
